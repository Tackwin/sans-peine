...
private:
  ...
  float    _ax = 0, _ay = 0, _az = 0;           // accelerometer raw
  float    _aax = 0, _aay = 0, _aaz = 0;        // accelerometer processed

  uint8_t  _gfs = 0;
  float    _raw2dps = 1.0/131.0;
  float    _gx = 0, _gy = 0, _gz = 0;           // gyro raw
  float    _gax = 0, _gay = 0, _gaz = 0;        // gyro processed.
  float    _pitch = 0, _roll = 0, _yaw = 0;     // used by user
